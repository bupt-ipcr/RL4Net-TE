...
public:
   ...
   * \returns a pointer to the FlowMonitor object
   */
  Ptr<FlowMonitor> RLInstall (NodeContainer nodes);
  /**
  ...
  /**
   * \brief Enable RL flow monitoring on a single node
   * \param node A Ptr<Node> to the node on which to enable flow monitoring.
   * \returns a pointer to the FlowMonitor object
   */
  Ptr<FlowMonitor> RLInstall (Ptr<Node> node);
  /**
  ...
  /**
   * \brief Enable RL flow monitoring on all nodes
   * \returns a pointer to the FlowMonitor object
   */
  Ptr<FlowMonitor> RLInstallAll ();
  /**
